...
contract TradeRiserCrowdsale is Ownable{
  ...
  TradeRiserToken public token;

  address public distributionAddress;

  // Constructor
  constructor(address _tokenAddress) public {
    token = TradeRiserToken(_tokenAddress);
    owner = 0x75B2eBbBeFa94a206a8B15ca9efBa2e314031F77;

    distributionAddress = 0xE9dD7dFF9599f6228c59B2E5874163cDe42250EC;
  ...
  uint public constant ICO_MIN_CAP = 1 ether; //ether

  uint public tokensSold;
  uint public ethCollected;

  uint public constant MIN_DEPOSIT = 0.12 ether;
  ...
  function setupStages () internal {
    icoStages.push(Stage(1700,5000000 * ((uint)(10)**(uint)(decimals)), 7000, true));
    icoStages.push(Stage(1700,6000000 * ((uint)(10)**(uint)(decimals)), 4000, true));
    icoStages.push(Stage(1700,10000000 * ((uint)(10)**(uint)(decimals)), 3500, true));

    icoStages.push(Stage(1700,15000000 * ((uint)(10)**(uint)(decimals)), 2500, true));
    icoStages.push(Stage(1700,20000000 * ((uint)(10)**(uint)(decimals)), 1800, true));
    icoStages.push(Stage(1700,25000000 * ((uint)(10)**(uint)(decimals)), 1500, true));
    icoStages.push(Stage(1700,50000000 * ((uint)(10)**(uint)(decimals)), 600, true));
    icoStages.push(Stage(1700,119000000 * ((uint)(10)**(uint)(decimals)), 0, true)); 
  }
